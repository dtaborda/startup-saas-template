...
export function CourseCard({ course, enrollment }: CourseCardProps) {
  ...
  return (
    <Link href={`/portfolio/${course.id}`} className="group block">
      <Card className="overflow-hidden rounded-xl border-border/60 bg-card transition-colors hover:border-primary/30">
        <div
          className={cn(
