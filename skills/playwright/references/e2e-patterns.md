# Template-Specific E2E Patterns

## Local Documentation

For Template-specific Playwright patterns, see:

- `docs/developer-guide/end2end-testing.mdx` - Complete E2E testing guide

## Contents

The Template documentation covers patterns NOT in the generic playwright skill:
