...
description: >
  ...
  Trigger: When writing Playwright E2E tests (Page Object Model, selectors, MCP exploration workflow). For Template-specific UI conventions under ui/tests, also use the project E2E patterns reference.
license: Apache-2.0
metadata:
...
For project-specific E2E testing with authentication setup, environment variables, and test IDs, see:
- **Documentation**: [references/e2e-patterns.md](references/e2e-patterns.md)
